	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
				...
				<option value="1" <%= vo.getPaymentOption().equals("1") ? "selected":"" %>>현금구매</option>
				<option value="2" <%= vo.getPaymentOption().equals("2") ? "selected":"" %>>신용구매</option>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverName" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="<%= vo.getBuyer().getUserName()%>">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverPhone" class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="<%= vo.getBuyer().getPhone() %>" />
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverAddr" class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="<%= vo.getBuyer().getAddr() %>" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
